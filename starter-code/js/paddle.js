...
Paddle.prototype.restart = function(){
  this._posY = (Y_UPPER_LIMIT - Y_LOWER_LIMIT)/2 - PADDLE_HEIGHT/2;
};
...
Paddle.prototype.moveUp = function(){
  if(this._posY > Y_LOWER_LIMIT) this._posY -= PADDLE_MOVE_SPEED * TIME_DELTA;
}

Paddle.prototype.moveDown = function(){
  if(this._posY < Y_UPPER_LIMIT - PADDLE_HEIGHT) this._posY += PADDLE_MOVE_SPEED * TIME_DELTA;
}
